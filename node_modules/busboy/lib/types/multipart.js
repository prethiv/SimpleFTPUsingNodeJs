...
function Multipart(boy, cfg) {
  ...
  this.parser.on('drain', function() {
    ...
    part.on('header', function(header) {
      ...
      console.log('File info i',fileinfo.i)
      ...
      if (contype === 'application/octet-stream' || filename !== undefined) {
        ...
        onData = function(data) {
          ...
          fileinfo.received=nsize+data.length
          // console.log(fileinfo)
          // console.log('nsize :',nsize+data.length,' File info :',fileinfo.fileInfo.fileStuff.fileSize)
